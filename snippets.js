...
const DEFAULT_CONVERTER = "";  //可修改自定义后端api
const CLASH_CONFIG = "https://raw.githubusercontent.com/TokizakiAki/rule/refs/heads/main/rule_clash_meta.ini"; //可修改自定义订阅配置转换ini
...
async function hSub(r,c,u,UA,h){
  ...
  const p=new URLSearchParams();p.append("uuid",UUID);p.append("host",up);p.append("sni",up);p.append("path",tp);p.append("type","ws");p.append("encryption","none");p.append("security","tls");p.append("alpn","h3");p.append("fp","chrome");p.append("allowInsecure","0");
